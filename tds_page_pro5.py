...
def idelay(delaymin, delaymax):
	...
	for demtg in range(int(delay), -1, -1):
		print(trang+"["+xanh+"VKN"+trang+"] ["+xanh+"L         "+trang+"] ["+xanh+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+cam+"VKN"+trang+"] ["+cam+"L"+xanh+"O        "+trang+"] ["+cam+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+blue+"VKN"+trang+"] ["+blue+"L"+xanh+"O"+cam+"A       "+trang+"] ["+blue+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+lam+"VKN"+trang+"] ["+lam+"L"+xanh+"O"+cam+"A"+blue+"D      "+trang+"] ["+lam+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+tim+"VKN"+trang+"] ["+tim+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I     "+trang+"] ["+tim+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+xnhac+"VKN"+trang+"] ["+xnhac+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N    "+trang+"] ["+xnhac+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+den+"VKN"+trang+"] ["+den+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G   "+trang+"] ["+den+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+do+"VKN"+trang+"] ["+do+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.  "+trang+"] ["+do+str(demtg)+trang+"]",end="\r")
		sleep(0.2)
		print(trang+"["+vang+"VKN"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.. "+trang+"] ["+vang+str(demtg)+trang+"]",end="\r")
		sleep(0.3)
		print(trang+"["+vang+"VKN"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G..."+trang+"] ["+vang+str(demtg)+trang+"]",end="\r")
