...
"""
    ...
    def ndp_delay_tool(self, p):
        while(p>1):
            p=p-1
            print(f'[VKN][|][LO......][{p}]','     ',end='\r');sleep(1/6)
            print(f'[VKN][/][LOA.....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[VKN][-][LOAD....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[VKN][+][LOADI...][{p}]','     ',end='\r');sleep(1/6)
            print(f'[VKN][\][LOADIN..][{p}]','     ',end='\r');sleep(1/6)
            print(f'[VKN][|][LOADING.][{p}]','     ',end='\r');sleep(1/6)
